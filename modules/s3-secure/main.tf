...
resource "aws_s3_bucket" "logs" {
  ...
  tags = { Name = "${var.project_name}-security-logs" }
}
...
resource "aws_s3_bucket" "access_logs" {
  bucket        = "${var.project_name}-access-logs-${random_id.access_logs_suffix.hex}"
  force_destroy = true
}
...
resource "terraform_data" "random_id_dependency" {
